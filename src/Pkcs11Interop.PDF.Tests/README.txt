...
1.  Create directory "c:\Pkcs11Interop.PDF.Tests\" (or any other) 
    that will be used as an output directory for the tests
2.  Import certificate from "data/John_Doe.p12" file to your PKCS#11 enabled 
    device (smartcard, HSM etc.). Password for the PKCS#12 file is "password".
3.  Edit properties of Net.Pkcs11Interop.PDF.Tests.Pkcs11SignatureTest class 
    stored in Pkcs11SignatureTest.cs file to suit your needs.
